...
let main args = 
    ...
    let (f, file) =
        match day with
            ...
            | 13 -> (Day13.main, "resources/13.txt")
            | 14 -> (Day14.main, "resources/14.txt")
            | 15 -> (Day15.main, "resources/15.txt")
            | 16 -> (Day16.main, "resources/16.txt")
            | 17 -> (Day17.main, "resources/17.txt")
            | 18 -> (Day18.main, "resources/18.txt")
